      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-zinc-900 rounded-[2rem] sm:rounded-[3rem] p-8 sm:p-12 md:p-20 text-center relative overflow-hidden border border-white/10">
          ...
          <div className="relative z-10">
            ...
            <button onClick={() => { setCurrentView('home'); window.scrollTo(0, 0); }} className="w-full sm:w-auto px-10 py-4 bg-primary text-black font-black uppercase tracking-[0.2em] rounded-full hover:bg-white transition-all shadow-[0_0_30px_rgba(242,158,13,0.4)]">
              Back to Home
            </button>
          </div>
        </div>
