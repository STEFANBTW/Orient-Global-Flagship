...
export const Footer: React.FC<FooterProps> = ({ 
  ...
  return (
    <footer 
      id="orient-footer"
      className={`w-full bg-background text-foreground border-t border-border/40 relative flex flex-col justify-center transition-colors duration-500 ${
        isCinematic 
    ...
    >
      <div className="max-w-[90vw] lg:max-w-[67vw] mx-auto px-4 md:px-8 lg:px-12 w-full">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-12 mb-16">
          ...
          <div className="col-span-1 lg:col-span-2">
            ...
            >
              ...
              <span className="text-sm lg:text-base tracking-[0.18em] uppercase px-3 py-1 rounded-lg bg-primary/10 text-primary font-medium border border-primary/25 leading-none">
                Global
              </span>
            </div>
            ...
            <div className="flex gap-3">
              {[
                ...
                <a 
                  key={social.icon} 
                  className="w-9 h-9 lg:w-10 lg:h-10 rounded-xl bg-card text-foreground hover:bg-primary hover:text-white flex items-center justify-center transition-all shadow-soft border border-border/30 hover:border-transparent active:scale-95" 
                  href="#" 
        ...
        {/* Bottom Bar */}
        <div className="border-t border-border/40 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-[9px] text-muted-foreground uppercase tracking-[0.2em] font-bold">
