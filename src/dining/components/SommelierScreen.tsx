...
const SommelierScreen: React.FC = () => {
 ...
 <h1 className="text-6xl md:text-8xl font-bold text-background mb-6 leading-tight">
 The Sommelier’s <br/>
 ...
 {/* AI Section */}
 <section className="py-16 px-6 relative bg-background ">
 <div className="max-w-5xl mx-auto">
 <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
 <div className="lg:col-span-5 space-y-5">
 <h2 className="text-3xl font-bold text-foreground ">Ask the <span className="text-primary">Sommelier</span></h2>
 ...
 <div>
 <p className="text-xs font-bold text-background">AI-Powered</p>
 <p className="text-[10px] text-muted-foreground">Curated by taste algorithms</p>
 </div>
 </div>
 </div>
 ...
 <label className="block text-[10px] font-medium text-muted-foreground uppercase tracking-wider">Describe your dish</label>
 <div className="relative">
 <input className="w-full bg-neutral-dark/50 border border-neutral-mid text-background placeholder:text-muted-foreground rounded-lg py-3 px-4 text-sm focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all" placeholder="I'm having the Spicy Prawn Curry..." type="text"/>
 <span className="material-icons absolute right-4 top-3 text-muted-foreground text-lg">search</span>
 </div>
 ...
 <h2 className="text-4xl font-sans font-bold text-background mt-3 mb-4">Science of the Soil</h2>
 ...
 <div>
 <h3 className="text-2xl font-bold text-background mb-1">The Zobo Infusion</h3>
 <p className="text-primary text-sm font-medium">Hibiscus Sabdariffa</p>
 </div>
 <div className="prose prose-invert prose-sm text-muted-foreground font-light">
 <p className="mb-3">
 ...
 <div className="grid grid-cols-3 gap-4 pt-4 border-t border-transparent">
 <div>
 <span className="block text-xl font-bold text-background">48h</span>
 <span className="text-[10px] text-muted-foreground uppercase">Steeping Time</span>
 </div>
 <div>
 <span className="block text-xl font-bold text-background">3.2</span>
 <span className="text-[10px] text-muted-foreground uppercase">pH Level</span>
 </div>
 <div>
 <span className="block text-xl font-bold text-background">0%</span>
 <span className="text-[10px] text-muted-foreground uppercase">Alcohol</span>
 </div>
 </div>
 </div>
 </div>
 ...
 <div>
 <h3 className="text-2xl font-bold text-background mb-1">The Kunu Fermentation</h3>
 ...
 <button className="text-primary hover:text-background transition-colors flex items-center gap-2 text-xs font-bold uppercase tracking-wider">
 ...
 {/* Wine & Malt List */}
 <section className="py-16 bg-background overflow-hidden" id="wines">
 <div className="max-w-6xl mx-auto px-6">
 <div className="flex flex-col md:flex-row justify-between items-end mb-12 border-b border-primary/20 pb-5">
 <div>
 <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-1">The Reserve List</h2>
 <p className="text-muted-foreground text-sm">Curated specifically for the Orient palate.</p>
 </div>
 <div className="flex gap-3 mt-5 md:mt-0">
 <button className="px-3 py-1.5 rounded-full bg-primary text-white text-xs">Reds</button>
 <button className="px-3 py-1.5 rounded-full border border-border text-muted-foreground hover:text-primary text-xs">Whites</button>
 <button className="px-3 py-1.5 rounded-full border border-border text-muted-foreground hover:text-primary text-xs">Malts</button>
 </div>
 </div>
 {/* List Container */}
 ...
 <button className="text-muted-foreground hover:text-background text-sm font-medium uppercase tracking-wider transition-colors border-b border-transparent hover:border-primary pb-1">View Full Cellar List</button>
 </div>
 </div>
 </section>
 ...
 <div className="max-w-7xl mx-auto px-6">
 <h2 className="text-3xl font-bold text-background mb-10 flex items-center gap-3">
...
const ReserveItem = ({ title, subtitle, region, year, price, image }: any) => (
 <div className="group relative flex flex-col md:flex-row items-baseline justify-between py-4 border-b border-border hover:border-primary/50 transition-colors cursor-pointer">
 <div className="md:w-1/2">
 <h4 className="text-lg md:text-xl font-medium text-foreground group-hover:text-primary transition-colors">{title}</h4>
 <p className="text-xs text-muted-foreground">{subtitle}</p>
 </div>
 <div className="flex justify-between w-full md:w-1/2 mt-1.5 md:mt-0 text-foreground/80 font-light text-sm">
 <span>{region}</span>
 <span>{year}</span>
...
const CocktailCard = ({ title, desc, image, ingredients }: any) => (
 ...
 <div className="p-5">
 <h3 className="text-lg font-bold text-background mb-1.5">{title}</h3>
 <p className="text-muted-foreground text-xs mb-3 line-clamp-2">{desc}</p>
 <div className="space-y-1.5 border-t border-border pt-3 hidden group-hover:block transition-all animate-fade-in">
 ...
 <button className="mt-3 w-full py-1.5 rounded border border-border text-background/80 hover:text-background hover:border-primary hover:bg-primary/10 text-xs transition-colors">View Method</button>
 </div>
 </div>
);
