...
const SommelierScreen: React.FC = () => {
    return (
        <div className="bg-slate-50 dark:bg-background-dark text-gray-800 dark:text-gray-200 font-sans">
             ...
             {/* AI Section */}
             <section className="py-24 px-6 relative bg-slate-50 dark:bg-background-dark">
             ...
             {/* Wine & Malt List */}
            <section className="py-24 bg-slate-50 dark:bg-background-dark overflow-hidden" id="wines">
