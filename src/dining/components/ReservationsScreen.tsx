...
const ReservationsScreen: React.FC = () => {
    ...
    return (
        <div className="bg-slate-50 dark:bg-background-dark text-gray-800 dark:text-gray-100 font-display min-h-screen selection:bg-primary selection:text-white">
            ...
            <section className="py-24 bg-gray-50 dark:bg-stone-900 transition-colors" id="occasions">
            ...
            <section className="py-24 bg-white dark:bg-background-dark relative overflow-hidden transition-colors" id="booking">
                ...
                <div className="max-w-5xl mx-auto px-6 relative z-10">
                    ...
                    <div className="flex justify-between mb-12 relative">
                        ...
                        {/* Step 2 Indicator */}
                        <div className="flex flex-col items-center gap-2 bg-white dark:bg-background-dark px-4 z-10">
                            <div className="w-10 h-10 rounded-full bg-gray-100 dark:bg-stone-900 border border-gray-300 dark:border-gray-600 text-gray-400 flex items-center justify-center font-bold border-4 border-white dark:border-background-dark">2</div>
                            <span className="text-sm font-medium text-gray-500">Preferences</span>
                        </div>
                        {/* Step 3 Indicator */}
                        <div className="flex flex-col items-center gap-2 bg-white dark:bg-background-dark px-4 z-10">
                            <div className="w-10 h-10 rounded-full bg-gray-100 dark:bg-stone-900 border border-gray-300 dark:border-gray-600 text-gray-400 flex items-center justify-center font-bold border-4 border-white dark:border-background-dark">3</div>
                            <span className="text-sm font-medium text-gray-500">Contact</span>
                        </div>
                    </div>
                    {/* Form Container */}
                    <div className="bg-gray-50 dark:bg-stone-900 border border-gray-200 dark:border-white/5 rounded-2xl p-8 md:p-12 shadow-2xl transition-colors">
                        {/* STEP 1 CONTENT */}
