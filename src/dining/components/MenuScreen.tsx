...
const MenuScreen: React.FC = () => {
    ...
    return (
        <div className="bg-slate-50 dark:bg-background-dark min-h-screen text-gray-800 dark:text-gray-100 font-serif selection:bg-primary selection:text-white pb-24">
            ...
            <section id="local" className="py-32 relative bg-slate-50 dark:bg-background-dark overflow-hidden">
            ...
            <section id="dessert" className="py-24 bg-slate-50 dark:bg-slate-50 text-gray-900">
