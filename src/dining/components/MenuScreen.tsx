...
const MenuScreen: React.FC = () => {
 ...
 return (
 <div className="bg-background min-h-screen text-foreground font-sans selection:bg-primary selection:text-background pb-24">
 ...
 <div className="inline-block border-y border-transparent py-2 px-6 mb-6 backdrop-blur-sm">
 <p className="text-background tracking-[0.4em] uppercase text-[10px] font-bold">Est. 2024 • Lagos</p>
 </div>
 <h1 className="text-5xl md:text-8xl font-bold text-background mb-6 drop-shadow-2xl font-sans leading-tight">
 ...
 <p className="text-base md:text-xl text-background mb-10 font-light max-w-2xl mx-auto leading-relaxed font-sans">
 {heroBlock.subtitle}
 </p>
 <a href="#local" className="inline-flex flex-col items-center text-background/80 hover:text-background transition-colors group">
 <span className="text-[10px] uppercase tracking-widest mb-2">Begin Journey</span>
 <div className="w-10 h-10 rounded-full border border-transparent flex items-center justify-center group-hover:border-primary group-hover:bg-primary/10 transition-all">
 ...
 <section id="local" className="py-12 relative bg-background overflow-hidden">
 ...
 <h2 className="text-4xl md:text-5xl mt-3 mb-4 font-bold text-foreground font-sans">From the Markets of Jos</h2>
 <p className="max-w-2xl mx-auto text-foreground/80 text-base">Authentic Nigerian delicacies prepared with locally sourced ingredients from the Plateau, bringing the warmth of home to your plate.</p>
 ...
 <h3 className="text-2xl text-background font-bold font-sans">{localMenu[0].title}</h3>
 <span className="text-primary font-bold text-lg">{localMenu[0].price}</span>
 </div>
 <p className="text-background/80 text-sm mb-4 line-clamp-2 group-hover:line-clamp-none transition-all">
 {localMenu[0].desc}
 </p>
 ...
 <p className="text-xs text-background/90 italic">"The melon seeds are sun-dried in Jos for 3 days to intensify the nutty flavor profile."</p>
 </div>
 </div>
 </div>
 </div>
 ...
 <h3 className="text-xl text-background font-bold font-sans">{localMenu[1].title}</h3>
 <div className="flex justify-between items-center mt-2">
 <span className="text-primary font-bold">{localMenu[1].price}</span>
 <button className="w-7 h-7 rounded-full bg-card/10 hover:bg-primary flex items-center justify-center text-background transition-colors">
 ...
 <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent"></div>
 <div className="absolute bottom-0 left-0 p-5 w-full">
 <h3 className="text-xl text-background font-bold font-sans">{localMenu[2].title}</h3>
 <div className="flex justify-between items-center mt-2">
 <span className="text-primary font-bold">{localMenu[2].price}</span>
 <button className="w-8 h-8 rounded-full bg-card/10 hover:bg-primary flex items-center justify-center text-background transition-colors">
 ...
 <h3 className="text-2xl text-background font-bold mb-1 font-sans">Whole Grilled Catfish</h3>
 <p className="text-background/80 text-xs mb-3">Marinated for 24 hours in our secret yaji spice blend.</p>
 </div>
 ...
 <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent"></div>
 <div className="absolute bottom-0 left-0 p-5 w-full">
 <h3 className="text-xl text-background font-bold font-sans">Smoky Party Jollof</h3>
 <div className="flex justify-between items-center mt-2">
 ...
 <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent"></div>
 <div className="absolute bottom-0 left-0 p-5 w-full">
 <h3 className="text-xl text-background font-bold font-sans">Spicy Beef Suya</h3>
 <div className="flex justify-between items-center mt-2">
 ...
 <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent"></div>
 <div className="absolute bottom-0 left-0 p-5 w-full">
 <h3 className="text-xl text-background font-bold font-sans">Special Moi Moi</h3>
 <div className="flex justify-between items-center mt-2">
 ...
 <button className="px-8 py-3 bg-transparent border border-primary text-primary hover:bg-primary hover:text-background transition-all rounded-full uppercase tracking-widest text-sm font-bold">View Full Local Menu</button>
 </div>
 </div>
 </section>

 {/* Section 3: Continental Classics (Horizontal Scroll) */}
 <section id="continental" className="py-12 bg-background border-y border-border ">
 ...
 <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-3 font-sans">Continental Classics</h2>
 <p className="text-muted-foreground mt-3 max-w-xl text-sm">A curated selection of the world's finest dishes, reimagined by our expert chefs.</p>
 </div>
 <div className="hidden md:flex gap-3">
 <button className="p-3 rounded-full border border-border hover:bg-primary hover:text-background hover:border-primary transition-colors text-muted-foreground">
 ...
 <h3 className="text-3xl font-bold text-center mb-12 font-display ">More From The Grill</h3>
 <div className="flex justify-between items-center border-b border-border pb-4">
 <div>
 <h4 className="text-xl font-bold ">T-Bone Steak (500g)</h4>
 <p className="text-muted-foreground text-sm">Best of both worlds, served with pepper sauce.</p>
 </div>
 <span className="text-lg font-bold text-primary">₦28,000</span>
 </div>
 <div className="flex justify-between items-center border-b border-border pb-4">
 <div>
 <h4 className="text-xl font-bold ">BBQ Pork Ribs</h4>
 <p className="text-muted-foreground text-sm">Slow cooked for 6 hours, glazed with honey BBQ.</p>
 </div>
 <span className="text-lg font-bold text-primary">₦18,000</span>
 </div>
 <div className="flex justify-between items-center border-b border-border pb-4">
 <div>
 <h4 className="text-xl font-bold ">Grilled Lobster Tail</h4>
 <p className="text-muted-foreground text-sm">Garlic butter, herbs, served with rice.</p>
 </div>
 ...
 <section id="drinks" className="py-12 relative bg-foreground text-background text-background overflow-hidden">
 ...
 {/* AI Sommelier Widget */}
 <div className="bg-card/5 backdrop-blur-xl border border-transparent p-6 rounded-2xl shadow-2xl">
 <div className="flex items-center gap-3 mb-5">
 
 <span className="text-[9px] uppercase tracking-widest font-bold text-primary">AURA Sommelier</span>
 </div>
 <h3 className="text-2xl font-bold mb-3 font-sans">What are you in the mood for?</h3>
 
 {/* Chat Interface Simulation */}
 <div className="space-y-5 mb-6">
 <div className="bg-card/10 p-5 rounded-2xl rounded-tl-none w-5/6">
 ...
 <button className="px-4 py-2 bg-card/10 text-background border border-transparent rounded-full text-xs hover:bg-card/20 transition-colors">Spicy Zobo</button>
 <button className="px-4 py-2 bg-card/10 text-background border border-transparent rounded-full text-xs hover:bg-card/20 transition-colors">Something Sweet</button>
 </div>
 </div>
 
 <div className="pt-6 border-t border-transparent">
 <p className="text-[10px] text-muted-foreground mb-3 uppercase tracking-widest">Today's Recommendations</p>
 <div className="flex items-center gap-4 p-3 rounded-xl hover:bg-card/5 transition-colors cursor-pointer group">
 ...
 <p className="text-xs text-muted-foreground">Ideally paired with red meat.</p>
 </div>
 ...
 <p className="text-lg text-background/80 font-light">Curated spirits, local brews, and artisanal infusions.</p>
 </div>
 ...
 <span className="text-2xl font-bold text-background tracking-widest uppercase border-b-2 border-primary pb-1">Zobo</span>
 </div>
 </div>
 ...
 <div className="absolute inset-0 bg-black/40 group-hover:bg-black/20 transition-colors flex items-center justify-center">
 <span className="text-2xl font-bold text-background tracking-widest uppercase border-b-2 border-primary pb-1">Kunu</span>
 </div>
 </div>
 <div className="relative group rounded-xl overflow-hidden aspect-[3/4] cursor-pointer">
 ...
 <div className="absolute inset-0 bg-black/40 group-hover:bg-black/20 transition-colors flex items-center justify-center">
 <span className="text-2xl font-bold text-background tracking-widest uppercase border-b-2 border-primary pb-1">Mixology</span>
 </div>
 </div>
 <div className="relative group rounded-xl overflow-hidden aspect-[3/4] mt-16 cursor-pointer">
 ...
 <div className="absolute inset-0 bg-black/40 group-hover:bg-black/20 transition-colors flex items-center justify-center">
 <span className="text-2xl font-bold text-background tracking-widest uppercase border-b-2 border-primary pb-1">Cellar</span>
 </div>
 </div>
 </div>
 </div>
 ...
 <section id="dessert" className="py-12 bg-background text-foreground">
 <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
 <div className="text-center mb-10">
 <span className="text-primary font-bold tracking-widest uppercase text-xs">Sweet Endings</span>
 <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-3 font-sans">Dessert & Small Chops</h2>
...
const NavLink = ({ href, children, scrolled }: { href: string, children: React.ReactNode, scrolled: boolean }) => (
 ...
 ${scrolled ? 'text-foreground hover:text-primary' : 'text-background/90 hover:text-background'}`}
 >
 {children}
...
const MenuItem = ({ image, title, price, desc }: { image: string, title: string, price: string, desc: string }) => (
 ...
 <h3 className="text-2xl text-background font-bold font-display">{title}</h3>
 <p className="text-background/80 text-sm mt-1">{desc}</p>
...
const ContinentalCard = ({ image, tag, title, desc, price }: any) => (
 ...
 <div className="absolute top-3 right-3 bg-card/90 backdrop-blur px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider text-primary shadow-sm">
 {tag}
 </div>
 </div>
 <div className="flex justify-between items-start">
 <div>
 <h3 className="text-xl font-bold text-foreground group-hover:text-primary transition-colors font-sans">{title}</h3>
 <p className="text-muted-foreground text-xs mt-1.5 line-clamp-2">{desc}</p>
 </div>
...
const DessertItem = ({ image, title, desc, price }: any) => (
 <div className="flex flex-col md:flex-row gap-6 items-center group cursor-pointer hover:bg-card/50 dark:hover:bg-black/5 p-3 rounded-2xl transition-all">
 ...
 <div className="w-full md:w-3/4 flex flex-col md:flex-row justify-between items-start md:items-center border-b border-border pb-3 group-hover:border-primary/50 transition-colors">
 <div>
 <h3 className="text-xl font-bold text-foreground mb-1 font-sans">{title}</h3>
 <p className="text-muted-foreground text-xs max-w-xs">{desc}</p>
 </div>
 <div className="mt-3 md:mt-0 flex flex-col items-end">
 <span className="text-lg font-bold text-primary">{price}</span>
 <button className="text-[10px] uppercase tracking-wider text-muted-foreground hover:text-primary mt-1 flex items-center gap-1 transition-colors font-bold">
