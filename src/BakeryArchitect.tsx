      ...
      <aside className="w-[450px] flex-none bg-white dark:bg-background-dark border-l border-gray-200 dark:border-white/10 flex flex-col shadow-2xl relative z-10">
        ...
        <div className="p-6 bg-white dark:bg-background-dark border-t border-gray-200 dark:border-white/10 shadow-lg">
          ...
          <div className="grid grid-cols-4 gap-3">
            ...
            {step < 4 ? (
              <button onClick={nextStep} className="col-span-3 bg-stone-900 hover:bg-background-dark dark:bg-white dark:text-stone-900 font-bold py-4 rounded-lg shadow-lg flex items-center justify-center gap-2 transform active:scale-95 transition-all text-white">
                Next Step
              </button>
            ) : (
