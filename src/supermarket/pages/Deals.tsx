...
const Deals: React.FC<DealsProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="font-display bg-slate-50 min-h-screen">
                 ...
                 >
                    ...
                    <div className="p-4 flex-grow flex flex-col">
                       ...
                       <div className="flex items-end gap-2 mb-4 mt-auto">
                          <span className="text-2xl font-black text-[#ef4343]">₦{item.price.toLocaleString()}</span>
                          <span className="text-sm text-gray-400 line-through mb-1">₦{(item.price * 2).toLocaleString()}</span>
                       </div>
