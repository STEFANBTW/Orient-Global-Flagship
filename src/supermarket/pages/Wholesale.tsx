              ...
              <div className="relative z-10 flex justify-between items-center">
                ...
                <div className="flex gap-3">
                   <motion.button 
                     ...
                     className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-slate-800 border border-gray-300 dark:border-slate-700 rounded-lg text-sm font-medium hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors text-slate-700 dark:text-slate-300"
                 ...
                 <tbody className="divide-y divide-gray-100 dark:divide-slate-800 text-sm">
                   ...
                   {filteredItems.map((item, idx) => (
                     ...
                     >
                        ...
                        <td className="py-2 px-4">
                           <span className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium ${(item.stock || 0) < 50 ? 'bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-200' : 'bg-green-100 dark:bg-slate-900 text-green-800 dark:text-green-200'}`}>
                              {item.stock}
                           </span>
                        </td>
                        <td className="py-2 px-4 font-medium text-slate-900 dark:text-white">₦{item.price.toLocaleString()}</td>
                        ...
                        <td className="py-2 px-4 text-right font-bold text-slate-900 dark:text-white">₦{(item.price * getQty(item.id)).toLocaleString()}</td>
                        <td className="py-2 px-4 text-center">
        ...
        >
           <div className="p-6 border-b border-gray-200 dark:border-slate-800 bg-white dark:bg-slate-900">
              ...
              <div className="text-xs text-slate-500 flex items-center gap-1">
                 <span className="w-2 h-2 rounded-full bg-slate-500 animate-pulse"></span> Live Sync
              </div>
           </div>
